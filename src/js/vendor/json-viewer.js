 ...
 *  Copyright (c) 2024 Mirko Perillo
 */
define([], function () {
	var Object_prototype_toString = ({}).toString;
	var DatePrototypeAsString = Object_prototype_toString.call(new Date);
	
	var _dom_container = document.createElement("pre");
    _dom_container.classList.add("json-viewer");
	/**
	 ...
	 */
	const showJSON = function(jsonValue, inputMaxLvl, inputColAt) {
		...
		_dom_container.innerHTML = "";
		walkJSONTree(_dom_container, jsonValue, maxLvl, colAt, 0);
	};
	...
	const getContainer = function() {
		return _dom_container;
	};

	const clear = () => {
		_dom_container.textContent = ''
	}
