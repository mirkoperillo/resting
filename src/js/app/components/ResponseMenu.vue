    ...
    <div class="row">
        <div class="col-md-9">
            <div class="row row-no-gutters" v-show="isActiveBody">
                <div class="col-md-2">
                    <select class="form-control" @change="changeFormat" v-model="selectedFormat">
                        <option v-for="format in bodyFormats" :key="format" :value="format.value">{{format.text}}</option>
                    </select>
                </div>
        ...
        <div class="col-md-3">
            <ul class="nav nav-pills pull-right">
                <li role="presentation" :class="{ active: isActiveBody }"><a href="#"  @click.stop="showBodyPanel">Body</a></li>
                <li role="presentation" :class="{ active: isActiveHeaders }"><a href="#" @click.stop="showHeadersPanel">Headers</a></li>
            </ul>
        </div>
    </div>
</template>
